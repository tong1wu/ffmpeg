...
typedef struct D3D12VADecodeContext {
     ...
     *
     * The buffers.length is the same as D3D12VADecodeContext.max_num_res
     */
     ...
     *
     * The ref_resources.length is the same as D3D12VADecodeContext.max_num_res
     */
     ...
     *
     * The ref_subresources.length is the same as D3D12VADecodeContext.max_num_res
     */
    ...
    /**
     * The array of indexes used to map from the surface index to the DXVA index
     *
     * The index_mapped.length is the same as D3D12VADecodeContext.max_num_res
     */
    int *index_mapped;
