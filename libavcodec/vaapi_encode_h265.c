                                                 ...
                                                 HWBaseEncodePicture *pic)
{
    ...
    VAEncPictureParameterBufferHEVC *vpic = ((VAAPIEncodePicture *)pic)->codec_picture_params;
    int i, j = 0;
    ...
    vpic->decoded_curr_pic = (VAPictureHEVC) {
        .picture_id    = ((VAAPIEncodePicture *)pic)->recon_surface,
    ...
    vpic->coded_buf = ((VAAPIEncodePicture *)pic)->output_buffer;
                                               ...
                                               VAAPIEncodeSlice *slice)
{
    ...
    *vslice = (VAEncSliceParameterBufferHEVC) {
        ...
        .slice_fields.bits = {
            .last_slice_of_pic_flag       = slice->index == ((VAAPIEncodePicture *)pic)->nb_slices - 1,
