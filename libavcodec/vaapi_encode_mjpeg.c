                                                  ...
                                                  HWBaseEncodePicture *pic)
{
    ...
    JPEGRawFrameHeader                *fh = &priv->frame_header;
    JPEGRawScanHeader                 *sh = &priv->scan.header;
    VAEncPictureParameterBufferJPEG *vpic = ((VAAPIEncodePicture *)pic)->codec_picture_params;
    ...
    *vpic = (VAEncPictureParameterBufferJPEG) {
        .reconstructed_picture = ((VAAPIEncodePicture *)pic)->recon_surface,
        .coded_buf             = ((VAAPIEncodePicture *)pic)->output_buffer,
    ...
    ((VAAPIEncodePicture *)pic)->nb_slices = 1;
